...
MIDDLEWARE = [
    'middlewares.block_suspicious_requests.BlockSuspiciousRequestsMiddleware',  # наш фильтр блокировщик сканирования
...
# Указываем директорию для загруженных медиа-файлов
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Указываем URL, по которому будут доступны медиа-файлы
MEDIA_URL = '/media/'

# Static files (CSS, JavaScript, Images)
# https://docs.djangoproject.com/en/4.2/howto/static-files/

# Указываем директорию для сборки статических файлов
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Указываем URL, по которому будут доступны статические файлы
STATIC_URL = '/static/'

# Добавляем директории, в которых Django будет искать статические файлы
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),
]


# Использовать встроенный logging Django
LOGGING = {
    "version": 1,
